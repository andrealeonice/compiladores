...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TK_IDENTIFIER = 275,           /* TK_IDENTIFIER  */
    LIT_INTEGER = 276,             /* LIT_INTEGER  */
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_KW_POINTER = 6,                 /* KW_POINTER  */
  ...
  YYSYMBOL_TK_IDENTIFIER = 20,             /* TK_IDENTIFIER  */
  YYSYMBOL_LIT_INTEGER = 21,               /* LIT_INTEGER  */
...
static const char *const yytname[] =
{
  ...
  "KW_BOOL", "KW_POINTER", "KW_IF", "KW_THEN", "KW_ELSE", "KW_WHILE",
  "KW_READ", "KW_PRINT", "KW_RETURN", "OPERATOR_LE", "OPERATOR_GE",
  "OPERATOR_EQ", "OPERATOR_DIF", "LEFT_ASSIGN", "RIGHT_ASSIGN",
...
{
      -3,   -16,     3,   -20,   -12,    -8,   -20,    -3,   -20,    -7,
     -12,   -19,   -20,     1,   -20,    -9,    -6,     1,   -14,   -20,
...
{
      26,     1,    26,     6,     5,    25,    21,    22,    30,    31,
      32,    13,    29,    10,    23,     7,    27,    28,    27,    28,
       9,    15,    11,    18,    12,    19,    20
};

static const yytype_int8 yycheck[] =
{
      17,     4,    17,     0,    20,    23,    20,    21,    26,    27,
      28,    30,    29,     7,    28,    27,    33,    34,    33,    34,
      28,    20,    29,    32,    10,    31,    17
};
...
{
       0,     4,    36,    37,    39,    20,     0,    27,    38,    28,
      39,    29,    38,    30,    40,    20,    41,    42,    32,    31,
      41,    20,    21,    28,    43,    43,    17,    33,    34,    29,
      43,    43,    43
};
